...
class MealResponse {
  ...
  factory MealResponse.fromJson(Map<String, dynamic> json) => MealResponse(
    meals: json["meals"] == null
        ? null
        : List<Map<String, String?>>.from(json["meals"].map((x) => Map.from(x).map((k, v) => MapEntry<String, String?>(k, v)))),
  );

  Map<String, dynamic> toJson() => {
    "meals": meals == null
        ? null
        : List<dynamic>.from(meals!.map((x) => Map.from(x).map((k, v) => MapEntry<String, dynamic>(k, v)))),
  };
}